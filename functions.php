...
function themes_starter_scripts_loader() {
	...
	// 2. Scripts
	wp_enqueue_script( 'main', get_template_directory_uri() . '/assets/js/main.bundle.js', false, $theme_version, true );
	wp_enqueue_script( 'vendors~main', get_template_directory_uri() . '/assets/js/vendors~main.bundle.js', false, $theme_version, true );
